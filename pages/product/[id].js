    ...
    return (
        <>
            ...
            <main className='w-100 flex flex-col'>
                <Navbar cart={cart} />
                {'images' in data ?
                    <div className='w-full grid px-2 md:px-4 gap-6 pb-10 mt-20 md:mt-20 grid-cols-1 md:grid-cols-12'>
                        <div className='flex flex-row md:flex-col gap-2 order-2 md:order-1 overflow-scroll md:overflow-hidden w-full md:col-span-1'>
                            {data.images.map((e, i) => {
                                return (
                        ...
                        <div className='md:col-span-4 order-3 w-full flex flex-col'>
                        ...
                        <div className='md:col-span-3 gap-1 p-4 order-4 border-[0.13rem] rounded border-red-500 w-full flex flex-col h-fit justify-start items-start'>
                            ...
                            <button className='p-2 w-full mt-6 flex flex-row justify-center items-center gap-1 rounded-full border-[0.14rem] border-red-500 bg-red-500  hover:text-red-500 text-white uppercase font-semibold hover:bg-white'>
