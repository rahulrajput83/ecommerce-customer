            ...
            <main className='w-full'>
                ...
                <main className='w-full flex flex-col md:flex-row box-border'>
                    <div className='mt-20 md:mt-16 px-2 md:px-16 pb-4 md:pb-10 w-full flex flex-col'>
                        <span className='text-xl uppercase font-medium mb-4 text-red-500 mx-auto'>Cart</span>
                        {cart && cart.length > 0 ?
                            <div className='w-full grid gap-6 justify-start items-start grid-cols-1 md:grid-cols-3'>
                                <div className='md:col-span-2 justify-start items-start font-medium flex flex-col gap-4 p-2 md:p-4 shadow-lg'>
                                    <span className='font-medium'>Total Item : {cart.length}</span>
                                            ...
                                            <div key={_id} className='w-full relative flex gap-4 flex-row justify-start items-start'>
                                                ...
                                                <div className='flex flex-col w-full'>
                                                    <div className='font-medium flex justify-between items-center w-full'>
                                                        <Link href={`/product/${product._id}`} className='w-full font-medium text-red-500 p-0 m-0'>
                                                            <ResponsiveEllipsis
                                                                text={product.title}
                                                                maxLine='1'
                                                                ellipsis='...'
                                                        ...
                                                        <button onClick={() => RemoveCart(_id)} className='font-medium text-red-500 z-10 text-xl bg-white'>
                                                            <MdDeleteOutline />
                                                        </button>
                                                    </div>
                                                    ...
                                                    <div className='flex gap-4 mt-4 items-center'>
                                                        <button onClick={() => MinusQuantity(_id, product.quantity)} className='p-2 font-medium bg-red-500 text-white'>
                                                            <BiMinus />
                                                        </button>
                                                        <span>{product.quantity}</span>
                                                        <button onClick={() => AddQuantity(_id, product.quantity)} className='p-2 font-medium bg-red-500 text-white'>
                                                            <BiPlus />
                                                        </button>
                                                    </div>
                                                </div>

                                                <span className='font-medium absolute left-0 px-2 py-1 bg-red-500 text-white z-10 text-sm'>&#x20b9; {product.price}</span>
                                            </div>
                                        )
                                    })}
                                </div>
                                <div className='md:col-span-1 justify-start h-auto items-start flex flex-col p-2 md:p-4 shadow-lg'>
                                    <span className='mb-2 text-lg font-medium'>Summary</span>
                                        ...
                                        <div className='w-full mt-6 flex flex-col items-center justify-center'>
                                            ...
                                            {accountData && accountData.address ?
                                                <div className='w-full inline'>
                                                    <span className='text-sm font-medium'>{accountData.address !== 'Empty' && accountData.address}</span>
                            ...
                            <div className='flex justify-center gap-2  text-lg items-center font-medium'>
                                ...
                                <Link href='/' className='border-[0.14rem] hover:bg-red-500 rounded-full hover:text-white font-medium border-red-500 px-4 py-[0.14rem]'>Home</Link>
                            </div>
                        }
                    </div>
                </main>
