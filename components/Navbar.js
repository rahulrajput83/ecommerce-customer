...
import { BiHomeAlt2, BiLogIn, BiSearch, BiUser } from 'react-icons/bi'
...
export default function Navbar() {
    ...
    return (
        <div className="flex flex-row fixed z-10 w-full justify-center items-center bg-red-500 p-3 box-border">
            ...
            <form className="flex mr-2 sm:mr-10 flex-row relative w-full sm:w-2/3 md:w-1/3 justify-center items-center">
